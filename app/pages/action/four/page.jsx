...
import recyle from '../../../assets/water.png'
      ...
      <div>
        ...
        className='w-80'>
          <h1 className='font-bold mb-2 text-green-800 text-lg'>
            ...
            <p>
            Perbaiki kebocoran keran, kurangi waktu mandi, dan gunakan air secara bijaksana. Praktik penghematan air adalah langkah kritis untuk menjaga ketersediaan air bersih, terutama di era perubahan iklim saat ini.
            </p>
        </motion.div>
        <motion.div
